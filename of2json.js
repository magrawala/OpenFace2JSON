...
for (var i in ptsFiles) {
    ...
    //Pts 0 - 16 are on the face contour, 17-21 are left eyebrow,
    //22-26 are right eyebrow, 27-30 are nose centerline, 31 - 35 are
    //nose bottom, 36-41 are left eye, 42-47 are right eye,
    //48-53 are upper lip top, 54-59 are lower lip bottom,
    //60-63 are upper lip bottom, 64-67 are lower lip bottom.
